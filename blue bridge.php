...
<header style="display: flex; flex-direction: row;">
	...
	<section class="home" id="home">
		<center><div class="home-text">
			<h1>Blue <br> Bridge</h1><br>
		</div></center>
	</section>
	<section class="about-dipaculao" id="about-dipaculao">
		<div class="title">
			<h2> WELCOME TO BLUE BRIDGE!</h2>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
		...
		<h4 align="justify">A bridge that connect North Poblacion to the beautiful beautiful beach of Dipaculao. It is best for trekking and perfect spot for photography.</h4>
	<br>
	...
	<section class="destination" id="destination">
		...
		<div class="destination-content">
			...
			<div class="col-content">
				<a href="blue_bridge.php"><img src="css/images/bluebridge2.JPG">
				<h5>Blue Bridge</h5></a>
			</div>
			<div class="col-content">

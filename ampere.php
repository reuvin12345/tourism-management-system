...
<header style="display: flex; flex-direction: row;">
	...
	<section class="home" id="home">
		<center><div class="home-text">
			<h1>Ampere <br> Beach</h1><br>
		</div></center>
	</section>
	<section class="about-dipaculao" id="about-dipaculao">
		<div class="title">
			<h2> WELCOME TO AMPERE BEACH!</h2>
			<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="css/images/ampere beach.jpg" class="d-block w-100" style="height: 400px;" alt="">
    </div>
    <div class="carousel-item">
      <img src="css/images/ampere.jpg" class="d-block w-100" style="height: 400px;" alt="">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
		...
		<h4 align="justify">Ampere Beach is located in the municipality of Dipaculao, Aurora in the Philippines. It is a beach where tourists go not for swimming but for its magnificent sight it has to offer. The beach is known for its smooth rocks of various sizes and colors, massive waves and breathtaking view of sunrise.</h4>
		<br<

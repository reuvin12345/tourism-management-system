...
<div class="header">
    <div class="side-nav">
        <a href="user9-dashboard.php">
            <img src="tw/images/logo.png" logo="logo-img" style="width: 55%; margin-left: 27%; margin-bottom: 10%;" class="dashboard-logo">
            <center><p style="color: white; font-weight: bold; font-size: 30px; margin-bottom: 20%">Twin Cave</p></center>
        </a>
        <ul class="nav-links">
            <li><a href="user9-dashboard.php"><i class="fa-solid fa-house mb-3"></i><p>Dashboard</p></a></li>
            <li><a href="tw/user9-register.php"><i class="fa-regular fa-user mb-3"></i><p>Register</p></a></li>
            <li><a href="tw/user9-restorepage.php"><i class="fa-solid fa-trash mb-3"></i><p>Restore</p></a></li>
    ...
    <div class="cards mt-4" style="margin-left: 24%;">
        <div class="row">
            <?php 
            include 'connection.php';
            $count_gender = mysqli_query($con, "SELECT SUM(male) as male FROM tw");
            ...
            <div class="card-body">
                ...
                <h1><?php echo $gender1 = $row_count["male"];?></h1>
            </div>
            </div>
            <div class="card text-bg-danger mb-3 mx-4" style="max-width: 15rem; height: 7rem;">
            <?php $count_gender = mysqli_query($con, "SELECT SUM(female) as female FROM tw");
            $row_count = mysqli_fetch_assoc($count_gender);?>
                <div class="card-body">
                <h5 class="card-title">Female</h5>
                <h1><?php echo $gender2 = $row_count["female"];?></h1>
                <p class="card-text"></p>
            </div>
            </div>
                <div class="card text-bg-success mb-3 mx-4" style="max-width: 15rem; height: 7rem;">
                <?php $count_gender = mysqli_query($con, "SELECT SUM(foreign_male) as foreign_male FROM tw");
                $row_count = mysqli_fetch_assoc($count_gender);?>
                <div class="card-body">
            ...
            <div class="row">
                <div class="card text-bg-danger mb-3 mx-4" style="max-width: 15rem; height: 7rem;">
                <?php $count_gender = mysqli_query($con, "SELECT SUM(foreign_female) as foreign_female FROM tw");
                $row_count = mysqli_fetch_assoc($count_gender);?>
                <div class="card-body">
            ...
            <?php $count_male = mysqli_query($con, "SELECT (SELECT SUM(male) FROM tw) as male, 
                ...
                <h1 style="color: white;"><?php echo $row_count['other_female'] + $row_count['other_male'] + $row_count['male'] + $row_count['female'] + $row_count['foreign_female'] + $row_count['foreign_male'];?></h1>
            </div>
            </div>
...
<div class="table-scroll">
    ...
    <?php
        ...
        ?>
            ...
            <td><div class="buttons"><button class="btn btn-primary"><a  href="tw/user9-update.php?updateid=<?php echo $rows['id'];?>" style="text-decoration: none; color: white;">Edit</button></a>
        <button class="btn btn-danger mx-4"><a  href="tw/user9-delete.php?deleteid=<?php echo $rows['id'];?>" style="text-decoration: none; color: white;">Delete</a></td></div>
        </tr>
    <?php
        }
    ?>

...
<div class="header">
    <div class="side-nav">
        <a href="user-dashboard.php">
            <img src="Aleman/images/logo.png" logo="logo-img" style="width: 55%; margin-left: 27%; margin-bottom: 10%;" class="dashboard-logo">
            <center><p style="color: white; font-weight: bold; font-size: 30px; margin-bottom: 20%">Aleman Falls</p></center>
        </a>
        <ul class="nav-links">
            <li><a href="user-dashboard.php"><i class="fa-solid fa-house mb-3"></i><p>Dashboard</p></a></li>
            <li><a href="Aleman/user-register.php"><i class="fa-regular fa-user mb-3"></i><p>Register</p></a></li>
            <li><a href="Aleman/user-restorepage.php"><i class="fa-solid fa-trash mb-3"></i><p>Restore</p></a></li>
    ...
    <div class="cards mt-4" style="margin-left: 24%;">
        <div class="row">
            ...
            $count_male = mysqli_query($con, "SELECT (SELECT SUM(male) FROM aleman) as male, 
                (SELECT SUM(other_male) FROM aleman) as male2");
            ...
            <?php $count_female = mysqli_query($con, "SELECT (SELECT SUM(female) FROM aleman) as female, 
                (SELECT SUM(other_female) FROM aleman) as female2");
            $row_count = mysqli_fetch_assoc($count_female);?>
                ...
                <?php $count_gender = mysqli_query($con, "SELECT SUM(foreign_male) as foreign_male FROM aleman");
            ...
            <div class="row">
                <div class="card text-bg-danger mb-3 mx-4" style="max-width: 15rem; height: 7rem;">
                <?php $count_gender = mysqli_query($con, "SELECT SUM(foreign_female) as foreign_female FROM aleman");
                $row_count = mysqli_fetch_assoc($count_gender);?>
                <div class="card-body">
            ...
            <?php $count_male = mysqli_query($con, "SELECT (SELECT SUM(male) FROM aleman) as male, 
            ...
            <hr class="sidebar-divider" style="color: black; width: 90%; overflow-x: scroll;">
<div class="table-scroll" style="width: 97%;">
        <table class="table table-responsive table-hover" style= "margin-top: 2%; margin-right: 20%; width: 100%;">
        <?php
    ...
    <?php
        ...
        ?>
            ...
            <td><div class="buttons"><button class="btn btn-primary"><a  href="Aleman/user-update.php?updateid=<?php echo $rows['id'];?>" style="text-decoration: none; color: white;">Edit</button></a>
        <button class="btn btn-danger mx-4"><a  href="Aleman/user-delete.php?deleteid=<?php echo $rows['id'];?>" style="text-decoration: none; color: white;">Delete</a></td></div>
        </tr>
    <?php
        }
    ?>

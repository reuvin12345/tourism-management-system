    	...
    	<div class="card">
    		<div class="card-body">
    			<div class="row">
    				...
    				<div class="col-sm-4 text-center">
    					<h3 class="mt-4 mb-3">Submit Your Review Here</h3>
    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group text-center mt-4">
                    ...
                    <button type="button" class="btn btn-primary" id="save_review" onclick='history.go()'>Close</button>
	        	</div>
	      	</div>
    	</div>
  	</div>
...
$(document).ready(function(){
    ...
    $('#save_review').click(function(){
        ...
        {
            $.ajax({
                url:"ratings/submit_rating10.php",
                method:"POST",
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if(data.review_data.length > 0)
                {
                    ...
                    {
                        html += '<table style="height: 200px; width: 100%; overflow: scroll;">'

...
<div class="header">
    <div class="side-nav">
        <a href="user2-dashboard.php">
            ...
            <center><p style="color: white; font-weight: bold; font-size: 20px; margin-bottom: 20%">Diarabasin Beach</p></center>
        </a>
        <ul class="nav-links">
            <li><a href="user5-dashboard.php"><i class="fa-solid fa-house mb-3"></i><p>Dashboard</p></a></li>
            <li><a href="Diarabasin/user5-register.php"><i class="fa-regular fa-user mb-3"></i><p>Register</p></a></li>
            <li><a href="Diarabasin/user5-restorepage.php"><i class="fa-solid fa-trash mb-3"></i><p>Restore</p></a></li>
    ...
    <div class="cards mt-4" style="margin-left: 24%;">
        <div class="row">
            <?php 
            include 'connection.php';
            $count_male = mysqli_query($con, "SELECT (SELECT SUM(male) FROM diarabasin) as male, 
                (SELECT SUM(other_male) FROM diarabasin) as male2");
            ...
            <?php $count_female = mysqli_query($con, "SELECT (SELECT SUM(female) FROM diarabasin) as female, 
                (SELECT SUM(other_female) FROM diarabasin) as female2");
            $row_count = mysqli_fetch_assoc($count_female);?>
                ...
                <?php $count_gender = mysqli_query($con, "SELECT SUM(foreign_male) as foreign_male FROM diarabasin");
            ...
            <div class="row">
                <div class="card text-bg-danger mb-3 mx-4" style="max-width: 15rem; height: 7rem;">
                <?php $count_gender = mysqli_query($con, "SELECT SUM(foreign_female) as foreign_female FROM diarabasin");
                $row_count = mysqli_fetch_assoc($count_gender);?>
                <div class="card-body">
            ...
            <?php $count_male = mysqli_query($con, "SELECT (SELECT SUM(male) FROM diarabasin) as male, 
...
<div class="table-scroll" style="width: 97%;">
    ...
    <?php
        ...
        ?>
            ...
            <td><div class="buttons"><button class="btn btn-primary"><a  href="Diarabasin/user5-update.php?updateid=<?php echo $rows['id'];?>" style="text-decoration: none; color: white;">Edit</button></a>
        <button class="btn btn-danger mx-4"><a  href="Diarabasin/user5-delete.php?deleteid=<?php echo $rows['id'];?>" style="text-decoration: none; color: white;">Delete</a></td></div>
        </tr>
    <?php
        }
    ?>

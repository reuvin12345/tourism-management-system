...
<header style="display: flex; flex-direction: row;">
	...
	<section class="home" id="home">
		<center><div class="home-text">
			<h1>Lipit<br> Beach</h1><br>
		</div></center>
	</section>
	<section class="about-dipaculao" id="about-dipaculao">
		<div class="title">
			<h2> WELCOME TO LIPIT BEACH!</h2>
			<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="css/images/lipit beach.jpg" class="d-block w-100" style="height: 400px;" alt="Lipit Beach">
    </div>
    <div class="carousel-item">
      <img src="css/images/lipit1.jpg" class="d-block w-100" style="height: 400px;" alt="Lipit Beach">
    </div>
    <div class="carousel-item">
      <img src="css/images/lipit3.jpg" class="d-block w-100"  style="height: 400px;" alt="Lipit Beach">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
		...
		<h4 align="justify">Lipit Beach is located 2 kilometers from the town proper of Dipaculao and is known for its wide sea shores and the beach it self is perfect for surfing. Also, Lipit beach one of the famous place for prenuptial photography  and best for sunrise waiting.</h4>
	<br>

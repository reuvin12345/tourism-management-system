...
<header style="display: flex; flex-direction: row;">
	...
	<section class="home" id="home">
		<center><div class="home-text">
			<h1>Twin<br> Cave</h1><br>
		</div></center>
	</section>
	<section class="about-dipaculao" id="about-dipaculao">
		<div class="title">
			<h2> WELCOME TO TWIN CAVE!</h2><br>
			<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="css/images/tw.jpg" class="d-block w-100" style="height: 400px;" alt="Lipit Beach">
    </div>
    <div class="carousel-item">
      <img src="css/images/twin cave in dibutunan.jpg" class="d-block w-100" style="height: 400px;" alt="Lipit Beach">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
		...
		<h4 align="justify">Dibutunan twin cave is headquartered in Central Luzon. The twin cave is found in Brgy. Dibutunan, Dipaculao, Aurora and it takes 10 minutes of walk to the different rock formations to get there were mountains and sea meets. The twin cave is known for its magnificent rock formations and perfect for photography.</h4>
	<br>
